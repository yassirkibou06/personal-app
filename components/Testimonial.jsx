...
const Testimonial = () => {
    ...
    return (
        <Swiper
            ...
            loop={true}
            modules={[Autoplay]}
            className="mb-12 mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8"
        >
            {boxInfo.map((item, index) => (
                <SwiperSlide key={index} className="rounded-lg bg-[#FFF7E7] p-8 w-fit">
                    <div class="flex items-center gap-4">
                        ...
                        />
                        <div>
                            <div class="flex justify-center gap-0.5 text-pry-bleu">
                                <svg
                        ...
                        <p class="mt-1 text-lg font-medium text-gray-700">{item.name}</p>
                        </div>
                    </div>
